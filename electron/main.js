        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!result.canceled && result.filePaths.length > 0) {
                    ...
                    return [2 /*return*/, { path: result.filePaths[0], content: content }];
                }
                return [2 /*return*/, null];
        }
    });
}); });
ipcMain.handle('file:save', function (_, filePath, content) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        fs.writeFileSync(filePath, content, 'utf-8');
        return [2 /*return*/, true];
    });
}); });
ipcMain.handle('file:saveAs', function (_, content) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
ipcMain.handle('latex:compile', function (_, texFilePath) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                var dir = path.dirname(texFilePath);
                var file = path.basename(texFilePath);
                ...
                pdflatex.on('close', function (code) {
                    ...
                    var logPath = texFilePath.replace('.tex', '.log');
                    var logs = '';
                ...
                pdflatex.on('error', function (err) {
                    reject(err);
                });
            })];
    });
